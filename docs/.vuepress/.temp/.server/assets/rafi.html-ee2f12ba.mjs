...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/RAFI/rafi.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const rafi_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "rafi.html.vue"]]);
export {
  rafi_html as default
};
