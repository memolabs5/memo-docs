<template><div><h1 id="memo-user节点命令详解" tabindex="-1"><a class="header-anchor" href="#memo-user节点命令详解" aria-hidden="true">#</a> MEMO User节点命令详解</h1>
<h1 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h1>
<p>本文将详细介绍MEMO系统User节点的命令行功能使用；用户需要首先下载二进制并执行程序 <strong>mefs-user</strong> ，从而启动Memo User节点。</p>
<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2>
<p>查看User节点中可以使用的所有功能简介和用法</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>示例设置节点根目录为：~/.memo-user</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user wallet <span class="token builtin class-name">export</span> <span class="token variable">$wallet</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参数$wallet 为钱包地址</p>
<p><strong>查看钱包的加密上传密码</strong></p>
<p>注：</p>
<p>钱包的上传密码是在上传对象时选择，如果上传对象时指定使用aes1模式，则表示使用的是桶密码，如果指定aes2模式，则表示使用的是对象密码。在下载对象的时候，需要指定对应的加密模式（aes1/aes2）的密码。</p>
<p>此命令就是用于查看本钱包的桶密码(aes1)或者对象密码（aes2）。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user wallet generate
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="命令用法-4" tabindex="-1"><a class="header-anchor" href="#命令用法-4" aria-hidden="true">#</a> 命令用法</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参数说明" tabindex="-1"><a class="header-anchor" href="#参数说明" aria-hidden="true">#</a> 参数说明</h3>
<p>wallet address: 钱包地址
bucketID： 桶id
objectID： 对象id
stripeID： 数据条带id
--password: 钱包密码
--enc: 加密模式</p>
<h3 id="使用范例" tabindex="-1"><a class="header-anchor" href="#使用范例" aria-hidden="true">#</a> 使用范例</h3>
<p>以下命令查看本钱包的桶0的aes1模式上传密码（设置桶密码的时候objectID和stripeID要设置成0）</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-config命令" tabindex="-1"><a class="header-anchor" href="#_4-config命令" aria-hidden="true">#</a> 4.config命令</h2>
...
<p>配置文件所在路径：节点根目录下 &quot;.memo-user/config.json&quot;</p>
...
<p>NAME:
mefs-user config set - Set config key</p>
<p>USAGE:
mefs-user config set [command options] [arguments...]</p>
<p>OPTIONS:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_6-gateway命令" tabindex="-1"><a class="header-anchor" href="#_6-gateway命令" aria-hidden="true">#</a> 6.gateway命令</h2>
<h3 id="简介-6" tabindex="-1"><a class="header-anchor" href="#简介-6" aria-hidden="true">#</a> 简介</h3>
<p>本命令为启动gateway（网关），等待节点同步完成之后才可成功访问</p>
...
COMMANDS:
   ...
   help, h  Shows a list of commands or <span class="token builtin class-name">help</span> <span class="token keyword">for</span> one <span class="token builtin class-name">command</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>子命令简介</strong></p>
<p>run                  启动 gateway
stop                 停止Gateway</p>
...
<p>--username value, -n value                         输入访问网关的用户名（默认为：memo）
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>访问端口127.0.0.1:8080 即访问user端控制台；</p>
<h2 id="_7-register命令" tabindex="-1"><a class="header-anchor" href="#_7-register命令" aria-hidden="true">#</a> 7.register命令</h2>
<h3 id="简介-7" tabindex="-1"><a class="header-anchor" href="#简介-7" aria-hidden="true">#</a> 简介</h3>
<p>此命令首先为钱包地址注册一个MEMO系统的账户ID，然后将该钱包账户注册为指定角色（User、Keeper、user），最后将该角色加入指定的group中；</p>
<p>请注意：User节点调用<code v-pre>daemon start</code>启动过程中会自动根据参数指定生成账户id、注册角色、加入group；</p>
<h3 id="命令用法-7" tabindex="-1"><a class="header-anchor" href="#命令用法-7" aria-hidden="true">#</a> 命令用法</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>NAME:
   mefs-user register - register an account <span class="token function">id</span> <span class="token keyword">for</span> the wallet first, <span class="token keyword">then</span> register a role <span class="token keyword">for</span> it, at last, <span class="token function">add</span> it into a group.

USAGE:
   mefs-user register <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>role <span class="token punctuation">(</span>user/keeper/user<span class="token punctuation">)</span><span class="token punctuation">]</span> <span class="token punctuation">[</span>group index<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参数说明：pwd为钱包密码，user表示指定的角色为user，1为指定此节点加入group 1</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user net connect /ip4/1.2.3.4/tcp/5678/p2p/12D<span class="token punctuation">..</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user net findpeer 12D3KooWHWKAGipKn9QCBEnNxf1ERhRud9qPsWTu9PqFrBm9A9kz
...
<p>用于user节点申明自己的公网ip地址；(仅user节点需要使用该命令)</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user state <span class="token parameter variable">-h</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>子命令列表</strong></p>
<p>post          查看User与provider节点间存储订单的付费和惩罚信息<br>
pay           查看节点当前的存储账户余额和memo余额
withdraw      provider节点结算当前存储收益</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user role list
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user info <span class="token parameter variable">-all</span> <span class="token boolean">true</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user settle <span class="token parameter variable">-h</span>

COMMANDS:
   setDesc               Set description <span class="token keyword">for</span> a node. Especially <span class="token keyword">for</span> users, <span class="token keyword">if</span> desc is <span class="token builtin class-name">set</span> to <span class="token string">'cloud'</span>, they will be selected as <span class="token function">dc</span> <span class="token keyword">in</span> buckets preferentially.
...
<p>质押1Memo</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user settle pledgeAdd <span class="token string">"1 Memo"</span>
...
<p>查看节点质押信息</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user settle pledgeGet
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>pledgeWithdraw</li>
</ul>
<p>取出0.5Memo的质押到Fs账户</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user settle pledgeWithdraw <span class="token string">"0.5 Memo"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参数说明：金额参数要使用引号，金额和单位之间要有一个空格，单位不区分大小写，可以是Memo, NanoMemo, AttoMemo，它们之间的关系为：1
Memo=10<sup>9*NanoMemo=10</sup>18*AttoMemo</p>
<ul>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user settle pledgeRewardWithdraw <span class="token string">"0.5 Memo"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参数说明：金额参数要使用引号，金额和单位之间要有一个空格，单位不区分大小写，可以是Memo, NanoMemo, AttoMemo，它们之间的关系为：1
Memo=10<sup>9*NanoMemo=10</sup>18*AttoMemo</p>
<ul>
<li>withdraw</li>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user settle withdraw <span class="token string">"0.5 Memo"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参数说明：金额参数要使用引号，金额和单位之间要有一个空格，单位不区分大小写，可以是Memo, NanoMemo, AttoMemo，它们之间的关系为：1
Memo=10<sup>9*NanoMemo=10</sup>18*AttoMemo</p>
<ul>
<li>quitRole</li>
</ul>
<p>此命令使节点退出目前的角色，此时将不再能使用角色相关功能。但钱包余额不受影响，并且对于user和keeper角色，此时能够取出注册角色时提供的角色质押金额。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user settle quitRole --really-do-it
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user version
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_7-order命令" tabindex="-1"><a class="header-anchor" href="#_7-order命令" aria-hidden="true">#</a> 7.order命令</h2>
<h3 id="简介-13" tabindex="-1"><a class="header-anchor" href="#简介-13" aria-hidden="true">#</a> 简介</h3>
<p>查看订单相关信息</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user order
...
COMMANDS:
   ...
   detail   get detail order <span class="token function">seq</span> info of one user
   proList  list all pros
   help, h  Shows a list of commands or <span class="token builtin class-name">help</span> <span class="token keyword">for</span> one <span class="token builtin class-name">command</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="joblist子命令" tabindex="-1"><a class="header-anchor" href="#joblist子命令" aria-hidden="true">#</a> jobList子命令</h3>
<p>列出所有任务信息</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user order jobList
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="paylist子命令" tabindex="-1"><a class="header-anchor" href="#paylist子命令" aria-hidden="true">#</a> payList子命令</h3>
<p>列出所有与user节点的订单状态</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user order payList
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="prolist子命令" tabindex="-1"><a class="header-anchor" href="#prolist子命令" aria-hidden="true">#</a> proList子命令</h3>
<p>列出所有user状态信息</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user order proList
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="get子命令-1" tabindex="-1"><a class="header-anchor" href="#get子命令-1" aria-hidden="true">#</a> get子命令</h3>
<p>查看指定user的订单信息</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user order get <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>user index required<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查看与指定user的交易信息；示例</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user order get <span class="token number">13</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="detail子命令" tabindex="-1"><a class="header-anchor" href="#detail子命令" aria-hidden="true">#</a> detail子命令</h3>
<p>查看订单的细节信息</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code> mefs-user order detail <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>user index required<span class="token punctuation">]</span> <span class="token punctuation">[</span>order nonce<span class="token punctuation">]</span> <span class="token punctuation">[</span>seq number<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="三-user日常使用命令" tabindex="-1"><a class="header-anchor" href="#三-user日常使用命令" aria-hidden="true">#</a> 三：user日常使用命令</h1>
<h2 id="_1-lfs命令" tabindex="-1"><a class="header-anchor" href="#_1-lfs命令" aria-hidden="true">#</a> 1.lfs命令</h2>
<h3 id="简介-14" tabindex="-1"><a class="header-anchor" href="#简介-14" aria-hidden="true">#</a> 简介</h3>
<p>此命令为user创建，上传，下载，查看容器和文件的集合命令。</p>
...
COMMANDS:
   ...
   help, h         Shows a list of commands or <span class="token builtin class-name">help</span> <span class="token keyword">for</span> one <span class="token builtin class-name">command</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="createbucket子命令" tabindex="-1"><a class="header-anchor" href="#createbucket子命令" aria-hidden="true">#</a> createBucket子命令</h3>
<p>此命令为创建桶</p>
...
<p>--bucket value, --bn value                  设置桶名
--policy value, --pl value                  设置纠删码（1）或者多副本策略（2）（默认为1）
--datacount value, --dc value               设置数据块数量（默认为3）
--paritycount value, --pc value             设置校验块数量（默认为2）</p>
<p>桶创建示例：</p>
<p>桶名称：test，存储策略：纠删码，数据块数量：10，校验块数量5</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="listbuckets子命令" tabindex="-1"><a class="header-anchor" href="#listbuckets子命令" aria-hidden="true">#</a> listBuckets子命令</h3>
<p>此命令为查看所有桶状态</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user lfs listBuckets
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="headbucket子命令" tabindex="-1"><a class="header-anchor" href="#headbucket子命令" aria-hidden="true">#</a> headBucket子命令</h3>
<p>此命令为查看指定桶的所有信息，下面为示例（test为桶名）</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="putobject子命令" tabindex="-1"><a class="header-anchor" href="#putobject子命令" aria-hidden="true">#</a> putObject子命令</h3>
<p>此命令为上传指定文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>--bucket value, --bn value            使用桶名
--object value, --on value            上传后文件名
--path value                          上传文件路径
--etag value                          选择校验方法（默认为：md5）
--enc value                           选择加密方式（默认为：aes）
--help, -h                            查看帮助</p>
<p><strong>上传示例</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user lfs putObject <span class="token parameter variable">--bn</span><span class="token operator">=</span>test <span class="token parameter variable">--on</span><span class="token operator">=</span><span class="token number">1</span>   <span class="token parameter variable">--path</span><span class="token operator">=</span>./index.txt
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="headobject子命令" tabindex="-1"><a class="header-anchor" href="#headobject子命令" aria-hidden="true">#</a> headObject子命令</h3>
<p>此命令为查看指定文件状态</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>--bucket value, --bn value                    查看的桶名
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="getobject子命令" tabindex="-1"><a class="header-anchor" href="#getobject子命令" aria-hidden="true">#</a> getObject子命令</h3>
<p>下载文件到指定路径</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code> mefs-user lfs getObject <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>arguments<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token parameter variable">--bucket</span> value, <span class="token parameter variable">--bn</span> value                桶的名称
<span class="token parameter variable">--object</span> value, <span class="token parameter variable">--on</span> value                桶中文件名称
<span class="token parameter variable">--etag</span> value, <span class="token parameter variable">--cid</span> value, <span class="token parameter variable">--md5</span> value    数据etag
<span class="token parameter variable">--start</span> value                             选择下载文件长度的起始位置
<span class="token parameter variable">--length</span> value                            下载文件的长度
<span class="token parameter variable">--path</span> value                              下载文件的存放路径
<span class="token parameter variable">--decrypt</span> value                           下载密码
...
--help, <span class="token parameter variable">-h</span>                                查看帮助
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意</p>
<p>--etag选项可以使用cid或者md5来代替，他们具有相同的意义。</p>
<p>--decrypt选项是上传对象时设置的桶密码或者对象密码，如果上传对象的时候使用了bucket密码，那么objectID设置的值将不会生效。</p>
<p><strong>下载示例</strong></p>
<p>示例1</p>
<p>下载未加密上传的对象。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user lfs getObject <span class="token parameter variable">--bn</span><span class="token operator">=</span>test <span class="token parameter variable">--on</span><span class="token operator">=</span><span class="token number">1</span>  <span class="token parameter variable">--path</span><span class="token operator">=</span>./index.html
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>示例2</p>
<p>使用etag和密码下载一个加密上传的对象。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>./mefs-user lfs getObject <span class="token parameter variable">--md5</span> f1c9645dbc14efddc7d8a322685f26eb <span class="token parameter variable">--userID</span> <span class="token number">36</span> <span class="token parameter variable">--bucketID</span> <span class="token number">0</span> <span class="token parameter variable">--objectID</span> <span class="token number">1</span> <span class="token parameter variable">--decrypt</span>  09a74f0cd7ff9d098f1753a83ed523d0c16b79ca2ce9ca5b5459ffada7e2376c <span class="token parameter variable">--path</span> aa
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="listobjects子命令" tabindex="-1"><a class="header-anchor" href="#listobjects子命令" aria-hidden="true">#</a> listObjects子命令</h3>
<p>查看指定桶的所有文件信息</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user lfs listObjects <span class="token parameter variable">-h</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>--bucket value, --bn value             要查看桶的名称
--marker value<br>
--prefix value                         过滤文件名称
--delimiter value                      文件输出分隔
--maxKeys value                        输出文件的最大数量（默认为1000）
--help, -h                             查看帮助</p>
<p><strong>列出所有文件示例</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user lfs listObjects
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="delobject子命令" tabindex="-1"><a class="header-anchor" href="#delobject子命令" aria-hidden="true">#</a> delObject子命令</h3>
<p>删除指定文件</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user lfs delObject <span class="token parameter variable">-h</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>--bucket value, --bn value            删除文件的桶名
--object value, --on value            删除文件名</p>
<h3 id="downloadobject子命令" tabindex="-1"><a class="header-anchor" href="#downloadobject子命令" aria-hidden="true">#</a> downloadObject子命令</h3>
<p>使用rpc下载对象</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user lfs downloadObject <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>arguments<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>--bucket value, --bn value              桶的名称
...
--help, -h                              查看帮助</p>
<h3 id="showstorage子命令" tabindex="-1"><a class="header-anchor" href="#showstorage子命令" aria-hidden="true">#</a> showStorage子命令</h3>
<p>显示节点的存储信息</p>
<h3 id="getpros子命令" tabindex="-1"><a class="header-anchor" href="#getpros子命令" aria-hidden="true">#</a> getPros子命令</h3>
<p>查看桶的user列表</p>
<h2 id="_2-recover命令" tabindex="-1"><a class="header-anchor" href="#_2-recover命令" aria-hidden="true">#</a> 2.recover命令</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_3-backup命令" tabindex="-1"><a class="header-anchor" href="#_3-backup命令" aria-hidden="true">#</a> 3.backup命令</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_4-restrict命令" tabindex="-1"><a class="header-anchor" href="#_4-restrict命令" aria-hidden="true">#</a> 4.restrict命令</h2>
<h3 id="简介-17" tabindex="-1"><a class="header-anchor" href="#简介-17" aria-hidden="true">#</a> 简介</h3>
<p>user节点设置白名单功能，创建桶时，优先选择白名单内节点。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>添加user节点至白名单</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>mefs-user restrict add PID
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参数PID为要添加至白名单的user节点ID</p>
<p>查看白名单内节点</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user restrict has PID
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参数PID为要添加至白名单的user节点ID</p>
<p>删除白名单节点</p>
...
<h3 id="简介-18" tabindex="-1"><a class="header-anchor" href="#简介-18" aria-hidden="true">#</a> 简介</h3>
<p>查询节点的token文件值，token文件位于节点根目录下，普通用户不用关注此值。</p>
<h3 id="命令用法-15" tabindex="-1"><a class="header-anchor" href="#命令用法-15" aria-hidden="true">#</a> 命令用法</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-user auth info
...
<h3 id="简介-19" tabindex="-1"><a class="header-anchor" href="#简介-19" aria-hidden="true">#</a> 简介</h3>
<p>此命令用于设置日志级别。
...
<h3 id="命令用法-16" tabindex="-1"><a class="header-anchor" href="#命令用法-16" aria-hidden="true">#</a> 命令用法</h3>
...
<p>mefs-user log setLevel level (debug/info/warn/error)</p>
<p>设置等级实例：</p>
