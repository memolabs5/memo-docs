<template><div><h1 id="commandline-mannual-for-prefacekeeper" tabindex="-1"><a class="header-anchor" href="#commandline-mannual-for-prefacekeeper" aria-hidden="true">#</a> CommandLine Mannual for Prefacekeeper</h1>
<h2 id="_1-preface" tabindex="-1"><a class="header-anchor" href="#_1-preface" aria-hidden="true">#</a> 1 Preface</h2>
<p>This article will introduce in detail the use of the command line function of the keeper-Node of the MEMO system; the keeper needs to download the binary and execute the program 'mefs-keeper' to start a Memo keeper-Node.</p>
<p>Usage</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>The example sets the root directory of the node to: ~/.memo-keeper</p>
<h3 id="_2-2-daemon" tabindex="-1"><a class="header-anchor" href="#_2-2-daemon" aria-hidden="true">#</a> 2.2 daemon</h3>
<p>Introduction</p>
<p>The command is used to start and stop an keeper-Node</p>
<p>Usage</p>
...
<p>Example</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-keeper wallet <span class="token builtin class-name">export</span> wallet-address
...
USAGE:
   mefs-keeper info <span class="token builtin class-name">command</span> <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>arguments<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-keeper net info self

ID:  <span class="token number">26</span> keeper <span class="token number">2</span>
...
12D3KooWHXmKSneyGqE8fPrTmNTBs2rR9pWTdNcgVG3Tt5htJef7 <span class="token punctuation">[</span>/ip4/121.37.158.192/tcp/23456<span class="token punctuation">]</span>
12D3KooWB5yMrUL6NG6wHrdR9V114mUDkpJ5Mp3c1sLPHwiFi6DN <span class="token punctuation">[</span>/ip4/192.168.1.46/tcp/4201<span class="token punctuation">]</span>
...
USAGE:
   mefs-keeper net connect <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>peer multiaddr <span class="token punctuation">(</span>/ip4/1.2.3.4/tcp/5678/p2p/12D<span class="token punctuation">..</span>.<span class="token punctuation">)</span><span class="token punctuation">]</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-keeper net findpeer 12D3KooW<span class="token punctuation">..</span>.
...
<p>Introduction</p>
<p>Used for the keeper node to declare its own public network ip address; (only the keeper node needs to use this command)</p>
<p>Usage</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>USAGE:
   mefs-keeper settle pledgeAdd <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>amount <span class="token punctuation">(</span>Memo / NanoMemo / AttoMemo<span class="token punctuation">)</span> required<span class="token punctuation">]</span>
...
For keepers and keepers, the role pledge amount provided when registering the role can be withdrawn after run quitRole.</p>
<p>Example</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_4-keeper-daily-used-commands" tabindex="-1"><a class="header-anchor" href="#_4-keeper-daily-used-commands" aria-hidden="true">#</a> 4 keeper daily used commands</h2>
...
USAGE:
   mefs-keeper backup <span class="token builtin class-name">export</span> <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>arguments<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
...
USAGE:
   mefs-keeper backup <span class="token function">import</span> <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>arguments<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
...
<p>Introduction</p>
<p>The keeper node sets the whitelist function. When creating a bucket, the nodes in the whitelist are given priority.</p>
<p>Usage</p>
...
USAGE:
   mefs-keeper restrict <span class="token builtin class-name">command</span> <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>arguments<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
...
<p>Example</p>
<p>Add keeper node to whitelist</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-keeper restrict <span class="token function">add</span> PID
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>The parameter PID is the keeper node ID to be added to the whitelist</p>
...
<p>mefs-keeper restrict has PID
The parameter PID is the keeper node ID to be added to the whitelist</p>
...
<p>Introduction</p>
<p>Query the value of the token file of the node. The token file is located in the root directory of the node. Ordinary keepers do not need to pay attention to this value.</p>
<p>Usage</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mefs-keeper auth info <span class="token parameter variable">-h</span>
...
USAGE:
   mefs-keeper log setLevel <span class="token punctuation">[</span>command options<span class="token punctuation">]</span> <span class="token punctuation">[</span>level <span class="token punctuation">(</span>debug/info/warn/error<span class="token punctuation">)</span><span class="token punctuation">]</span>
