...
<p>Email Example</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Network: megrez
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">--rm</span> <span class="token parameter variable">-v</span> <span class="token variable">$MEFS_PATH</span>:/root <span class="token parameter variable">--entrypoint</span> mefs-provider memoio/mefs-provider:latest bootstrap <span class="token function">add</span> <span class="token string">"/ip4/1.182.90.4/tcp/27360/p2p/12D3KooWFhw59q71vpM8LpRTZ4NJmteXLys2pryHAStxG4Mb3wrn"</span>
...
<figure><img src="@source/start-and-usage/how-to-start-with-Docker/megrez/provider.png" alt="provider" tabindex="0" loading="lazy"><figcaption>provider</figcaption></figure>
</div></template>
